...
public class FillPump 
{
	private LocalDateTime startTime, stopTime, initiate, terminate;
	@SuppressWarnings("unused")
	private Duration runTime, downTime;
	private boolean active, atCapacity, OP, DT;
	
	// Default Constructor
	public FillPump()
	{
		initiate = LocalDateTime.now(); // Time at which operation scheduling starts
	...
	// Constructor
	public FillPump(boolean activeArg)
	{
	...
	// Determines if the pool water level is at capacity
	public void setAtCapacity(boolean capArg)
	{
		atCapacity = capArg;
	}
	// Returns the atCapacity state
	...
	public String downTimeToString()
	{
		...
		String str = String.valueOf(c);
		String durationString = new String(str + " minutes(s)");
		return durationString;
	}
}
